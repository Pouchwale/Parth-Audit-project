...
everything in HR Module". So this suite checks that:
  ...
  * the Document Library holds one hundred and nine documents, and the Human Resources module
  ...
  * the library holds one hundred and nine documents (REQUIREMENTS s51 added
    ...
    s74 Maintenance's eight and s76 System / Management's eighteen);
