...
export const SEED_TRAINING_RECORD: RecordInstance<TrainingRecordData> = {
  ...
  data: {
    ...
    attendees: [
      { id: generateId("att"), employeeName: "Yogesh Rathod", department: "Pest Control Service Provider (Technician)", attended: true },
    ],
...
export const SEED_AWARENESS_TRAINING_RECORD: RecordInstance<TrainingRecordData> = {
  ...
  data: {
    ...
    attendees: [
      { id: "att-2025-12-24-1", employeeName: "Mr. Akash Patel", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-2", employeeName: "Mr. Ajay Vaghela", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-3", employeeName: "Ms. Kapila Barad", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-4", employeeName: "Mr. Meet Patel", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-5", employeeName: "Mr. Harsh Parmar", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-6", employeeName: "Mr. Chirag Parmar", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
      { id: "att-2025-12-24-7", employeeName: "Mr. Mukesh Patel", department: "Gujarat Printpack Publication Pvt. Ltd.", attended: true },
    ],
